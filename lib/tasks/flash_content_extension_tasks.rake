  ...
  namespace :extensions do
    namespace :flash_content do
      ...
      task :update => :environment do
        ...
        puts "Copying assets from FlashContentExtension"
        ...
        unless FlashContentExtension.root.starts_with? RAILS_ROOT # don't need to copy vendored tasks
          puts "Copying rake tasks from FlashContentExtension"
          local_tasks_path = File.join(RAILS_ROOT, %w(lib tasks))
          mkdir_p local_tasks_path, :verbose => false
          Dir[File.join FlashContentExtension.root, %w(lib tasks *.rake)].each do |file|
      ...
      task :sync => :environment do
        ...
        language_root = FlashContentExtension.root + "/config/locales"
